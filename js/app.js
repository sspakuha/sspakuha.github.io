...
$(document).ready(function () {
	...
	$('.filter__item').click(function () {
		var z = $(this).data('filter');
		$('.excursions__column').removeClass('_active');


		i = 0.5;
		$('.excursions__column.f_' + z).each(function () {
			$(this).attr('style', '--i:' + i);
			i += 0.5;
			if (i > 1.51) {
				i = 0.5;
		...
		if (z == 1) {
			$('.excursions__column').show().addClass('_active');
		}
		else {
			$('.excursions__column').hide();

			$('.excursions__column.f_' + z).show().addClass('_active');
		}

		$('.filter__item-link').removeClass('active');
		$(this).find('.filter__item-link').addClass('active');
	...
	function settt() {
		...
		$('.excursions__column').each(function () {
			$(this).attr('style', '--i:' + i);
			i += 0.5;
			if (i > 1.51) {
				i = 0.5;
